...
import dig from '../../assets/images/digital-web.svg'
  ...
  render() {
    return (
      <div>
        ...
        <div id="line" class="logo" style={{opacity: 0}}>
          <svg viewBox="0 0 558.07 79.86">
            <g fill="none" fill-rule="evenodd" stroke="#fff" stroke-width="1" class="lines">
              <path
                class="pt"
