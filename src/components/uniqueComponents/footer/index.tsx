...
const Footer = (props: any) => {
  ...
  return (
    <React.Fragment>
      <Container style={window.innerWidth > 768 ? {padding: '60px 0px 20px 0px'} :  {padding: '20px 0px 10px 0px'}} alignItems={'flex-start'}>
        <Box>
          <Flex flexDirection={'column'}>
            ...
            <Box>
              <Typography color="primary">
                <a href="mailto:hallo@oseven.de" style={{color: 'inherit', display: 'flex', alignItems: 'center', justifyContent: window.innerWidth > 768 ? 'flex-start':'center'}}>
            ...
            <Box>
              <Typography color="primary">
                <a href="tel:+491634412159" style={{color: 'inherit', display: 'flex', alignItems: 'center',justifyContent: window.innerWidth > 768 ? 'flex-start':'center'}}>
      ...
      <Flex
        ...
        justifyContent={window.innerWidth > 768 ? 'space-between' :"center"} alignItems="center" flexWrap="wrap" >
