...
import {contact, facebook, google, twitter, xing, phone, mail} from '../../../../assets'
import {ContainerBox} from '../../../'

const content = [
  {icon: facebook, href: 'https://www.facebook.com/osevenNBG/'},
  {
    icon: google,
    href:
  ...
  {icon: xing, href: 'https://www.xing.com/profile/Maximilian_Haensel'},
  {icon: twitter, href: 'https://twitter.com/maxhaensel_'},
]
